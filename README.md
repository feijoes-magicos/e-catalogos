...
DEPEDÊNCIAS => quanto a execução, concerne somente o uso da biblioteca json-server e da discernição de variáveis de ambiente disponibilizada pelo vite,
...
essenciais para a aplicação
    ...
    EXECUÇÃO => após configurar corretamente as dependências, rode o comando:
